...
\input{2020-02-06-ComplexNumbers}

\section{Geometry in \(\C\)}
\label{sec:geometry_in_c}

\input{2020-02-07-GeometryinC}
...
\input{2020-02-13-ComplexTopology}

\subsection{Sequences in \(\C\)}
\label{sub:sequences_in_c}

\input{2020-02-14-ComplexSequences}

\chapter{Complex Functions}
\label{cha:complex_functions}

\input{2020-02-20-ComplexContinuity}

\section{Differentiability in \(\C\)}
\label{sec:differentiability_in_c}

\input{2020-02-21-Holomorphic}	
\input{InverseOpenMapping}

\section{Power Series}
\label{sec:power_series}

\input{2020-02-28-PowerSeries}
...
\input{ConformalMappings}

\section{Riemann Mapping Theorem}
\label{sec:riemann_mapping_theorem}

\input{RiemannMappingThm}
